(function() {
	...
	var Cache = {
		...
		load: function() {
			...
			GameData.HighScore.Normal = parseInt(arr[2]);
			GameData.HighScore.Hardcore = parseInt(arr[3]);
			GameData.HighScore.SavedVersion = parseInt(arr[4]);
			GameData.currentBgmNumber = parseInt(arr[5]);
		}
	};
